...
<div class="ea-form-page">
    <div class="ea-page-head">
        <div>
            <h1>Tambah Arsip</h1>
            <p>
                Tambahkan registry link Google Drive tanpa mengubah atau memindahkan file aslinya.
            </p>
        </div>
    ...
    <div class="ea-note">
        SYNRGYPRO hanya menyimpan nama, kategori, dan link. Folder/file fisik tetap berada di Google Drive.
    </div>

    <form
        method="POST"
        action="{{ route('admin-all.e-arsip.store') }}"
        class="ea-card"
    >
        @csrf

        <div class="ea-card-head">
            <strong>DATA ARSIP BARU</strong>
            <small>
                Isi link folder/file Google Drive yang akan ditampilkan di E-Arsip.
            </small>
        </div>
